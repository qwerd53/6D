"""
Some functions are borrowed from FeatureMatcher: Detector-Free Local
Feature Matching with Transformers (https://github.com/zju3dv/FeatureMatcher) and modified here.
If using this code, please consider citing FeatureMatcher.
"""
