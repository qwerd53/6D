...
class MicKeyTrainingModel(pl.LightningModule):
    ...
    def forward_once(self, batch, training=True):
        ...
        mask0_expand = pred_mask0_bin
        mask1_expand = pred_mask1_bin
        m0_vals = mask0_expand[:, y0, x0]
        m1_vals = mask1_expand[:, y1, x1]
        ...
        H = torch.einsum('bni,bnj->bij', A_centered, B_centered)
