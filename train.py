...
def train_model(args, cfg):
    ...
    trainer = pl.Trainer(
        #OOM
        # precision="16-mixed",  # 鍚敤娣峰悎绮惧害
        # accumulate_grad_batches=4,
        precision="32",
        #gradient_clip_val=1.0,  # 闃叉姊害鐖嗙偢
        # limit_train_batches=1, # train鐢?0%鏁版嵁娴嬭瘯鍐呭瓨
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', default='Oryon/data')
