...
from Talk2DINO.src.open_vocabulary_segmentation.models.builder import MODELS
from Talk2DINO.src.open_vocabulary_segmentation.models.dinotext.pamr import PAMR
from Talk2DINO.src.open_vocabulary_segmentation.models.dinotext.masker import DINOTextMasker
from Talk2DINO.src.open_vocabulary_segmentation import us
from Talk2DINO.src.open_vocabulary_segmentation.datasets import get_template

from Talk2DINO.src.model import ProjectionLayer, VisualProjectionLayer, CLIPLastLayer, DoubleMLP
from Talk2DINO.src.loss import Contrastive
from Talk2DINO.src.hooks import average_text_tokens, get_vit_out, feats
...
class DINOText(nn.Module):
    ...
    def __init__(
        ...
        with open(os.path.join('Talk2DINO/configs', f"{proj_class}.yaml"), 'r') as config_file:
            config = yaml.safe_load(config_file)['model']
            
        ProjClass = getattr(importlib.import_module('Talk2DINO.src.model'), proj_model)
