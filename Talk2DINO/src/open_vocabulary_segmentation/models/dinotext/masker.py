...
from Talk2DINO.src.open_vocabulary_segmentation.models.dinotext.modules import FeatureEncoder

from Talk2DINO.src.open_vocabulary_segmentation.utils import get_logger
