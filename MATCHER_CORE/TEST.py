...
def get_dataset_args_dict(dataset_name='NOCS', root_path='Oryon/data', seed=42):
...
def test_model(args, cfg):
    ...
    datamodule = DataModule(
        args_dict,
        train_dataset_name='NOCS',  # 鍗犱綅锛屼笉鐢ㄨ缁?
    ...
    #     add_acc = result[0].get('add01d_acc', None)  # 鍋囪 validation_step 杩斿洖鐨?dict 涓?key 涓?'add01d_acc'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', default='Oryon/data', help='Path to dataset root')
