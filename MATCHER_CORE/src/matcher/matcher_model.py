...
class FeatureMatcher(nn.Module):
    def __init__(self, config):
        ...
        self.coarse_transformer = LocalFeatureTransformer(config['coarse'])
    ...
    def forward(self, data):
        ...
        #for visual
        data.update({
            'feat_c0_raw': feat_c0.clone(),  # [N, C, H, W]
            'feat_c1_raw': feat_c1.clone()  # [N, C, H, W]
        })

        # 2. coarse-level matcher module
        ...
        feat_c0, feat_c1 = self.coarse_transformer(feat_c0, feat_c1, mask_c0, mask_c1)
