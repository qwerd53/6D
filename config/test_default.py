...
_CN.MODEL = None
#test
# Register oryon model config (lowercase 'model' to match oryon.py)
_CN.model = CN()
_CN.model.use_catseg_ckpt = True

_CN.model.image_encoder = CN()
_CN.model.image_encoder.img_size = [48, 48]
...
_CN.loss=CN()
_CN.loss.pos_margin=None
_CN.loss.neg_margin=None
_CN.loss.neg_kernel_size=None  # 添加这行
_CN.loss.hard_negatives=None
_CN.loss.mask_type=None
_CN.test=CN()
_CN.test.mask_threshold=None
...
#added
_CN.FEATURE_MATCHER.DUAL_SOFTMAX.CHUNK_SIZE =None  # 默认值
_CN.FEATURE_MATCHER.DUAL_SOFTMAX.MIXED_PRECISION = True
#end
...
_CN.LOSS_CLASS.MASK_LOSS_WEIGHT =None
